...
# 6-Jun-2018; Last revision: 6-Jun-2018
...
f.write("//MDP automatically built using mdp_generator.py for v1 = %s and driver_type = %s (to alter these values, run the script again).\n"%(v1,driver_type))
