...
while True:
	...
	# Second vehicle
	screen.blit(get_image('car_grey.png'), ((x2_0 + t*v2)*scaleX - c_width/2, 218 - 1.8*scaleY - c_height/2))
	...
	other_vahicle_label = myfont.render("First vehicle", 1, (128,128,128))
	...
	other_vahicle_label = myfont.render("Second vehicle", 1, (128,128,128))
	screen.blit(other_vahicle_label, (625, 25))

	x_label = myfont.render("x Position: %dm"%(x2_0 + t*v2), 1, (0,0,0))
	screen.blit(x_label, (625, 45))

	y_label = myfont.render("y Position: 1.8m", 1, (0,0,0))
	screen.blit(y_label, (625, 65))
