...
parser.add_argument('--filename', '-f', type=str, default="smg_model", help='Output name for the file generated.')
args=parser.parse_args()

f = open("%s.smg"%args.filename, "w")
...
f.write("player p1\n")
f.write("	Decision_Making_Monitoring, Control\n")
f.write("endplayer\n\n")
...
f.write("	// Virtual state for the reward structures\n")
f.write("	[] actrState = 2 & x = length -> 1:(t' = max_time);\n\n")
...
f.write('rewards "Rlane"\n')
f.write("	[] lane = 2 & actrState = 1: 1;\n")
f.write("endrewards\n")

f.write('rewards "RendInLane"\n')
f.write("	[] x = length & t < max_time & lane = 1: 1;\n")
f.write("endrewards\n")

f.write('rewards "RendInTime"\n')
f.write("	[] x = length & t < max_time & t < 17: 1;\n")
f.write("endrewards\n")
