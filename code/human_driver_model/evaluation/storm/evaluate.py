...
# the automatic_model_checker.py script to model check in storm
# desired properties.
...
if generate_samples == True:
	for i in range(1,N+1):
		...
		os.system('python3 storm_model_checker.py properties.pctl %d %d %d'%(v,v1,x1_0))
...
plt.ylabel('P=? [F ((x = 500) & (t < %d)) || F (x = 500)]'%time_val)
